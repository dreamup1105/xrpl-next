                    ...
                    <div className="min-w-[500px] w-[500px] mx-auto">
                        <div className="rounded-[16px]  h-auto bg-[#21212A] text-white p-4">
                            <div className="px-2 mb-2">
                                ...
                                <div className="circleBase bg-[#272832] mx-auto mt-15 border-2 border-double border-gray-700 w-[160px] h-[160px] mb-[35px] flex justify-center">
                                ...
                                <div className="relative w-full mt-[5px] mb-[48px]">
                                    <input onKeyDown={handleKeyPress} type="text" className="h-[40px] w-full bg-[#0a0a0c] rounded-[16px] py-1 pl-9 pr-1" placeholder="username" />
