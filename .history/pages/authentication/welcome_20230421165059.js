                    ...
                    <div className="min-w-[500px] w-[500px] mx-auto">
                        <div className="rounded-[16px]  h-auto bg-[#21212A] text-white p-3">
                            <div className="px-2 mb-2">
                                ...
                                <div className="w-full text-center text-[14px] opacity-60 mb-[15px]" >Get started with the XRPL Dash in seconds by following these simple steps to set up your account. </div>
                                <div className="circleBase bg-gray-800 mx-auto mt-15 border-2 border-double border-gray-900 w-[160px] h-[160px] mb-[35px] flex justify-center">
