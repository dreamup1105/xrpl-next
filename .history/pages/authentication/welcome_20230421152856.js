                    ...
                    <div className="min-w-[500px] w-[500px] mx-auto">
                        <div className="rounded-[16px]  h-auto bg-[#21212A] text-white p-3">
                            <div className="px-2 mb-2">
                                <div className="w-full text-center text-[24px] mb-[10px]">Welcome! First things first...</div>
                                <div className="w-full text-center text-[14px] opacity-60" >Get started with the XRPL Dash in seconds by following these simple steps to set up your account. </div>
                                <div className="circleBase type1 w-[160px] h-[160px] mb-[35px] flex justify-center">
                                    <div className='w-[100px] h-[100px] relative'>
                                        ...
                                        {imageUrl && <img src={imageUrl} className='circleBase' />}
                                    </div>
                                </div>
                                ...
                                <div className="dotalign">
                                    <span className="h-[10px] w-[10px] bg-white opecity-[5%] rounded-full inline-block mr-7 ml-11"></span>
                                    <span className="h-[10px] w-[10px] bg-black rounded-full inline-block mr-7 ml-11"></span>
                                    <span className="h-[10px] w-[10px] bg-white rounded-full inline-block mr-7 ml-11"></span>
                                </div>
                            </div>
                        </div>
                    </div>
